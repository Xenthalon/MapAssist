    ...
    public static class PointOfInterestHandler
    {
        ...
        public static List<PointOfInterest> GetArea(MapApi mapApi, AreaData areaData, GameData gameData)
        {
            ...
            if (areaData.AdjacentLevels.Any())
            {
                ...
                //------------------------------------------------------
                // TODO: maybe we can get boss locations from MAServer?
                else if (areaData.Area == Area.CatacombsLevel4)
                {
                    pointsOfInterest.Add(new PointOfInterest
                    {
                        Area = areaData.Area,
                ...
                else if (areaData.Area == Area.DuranceOfHateLevel3)
                {
                    pointsOfInterest.Add(new PointOfInterest
                    {
                        Area = areaData.Area,
                ...
                else if (areaData.Area == Area.NihlathaksTemple)
                {
                    pointsOfInterest.Add(new PointOfInterest
                    {
                        Area = areaData.Area,
